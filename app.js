const MODULES = [
  {
    ...
    "desc": "Sintaks & tipe dasar"
  },
  {
    "id": 2,
    "title": "Ownership & Memori",
    "icon": "fa-solid fa-shield-halved",
    "desc": "Borrowing & slices"
  },
  {
    "id": 3,
    "title": "Struktur Data & OOP",
    "icon": "fa-solid fa-cubes",
    "desc": "Struct, enum, match"
  },
  {
    "id": 4,
    "title": "Error & Koleksi",
    "icon": "fa-solid fa-boxes-stacked",
    "desc": "Result, Vec, HashMap"
  },
  {
    "id": 5,
    "title": "Lanjutan & Concurrency",
    "icon": "fa-solid fa-bolt",
    "desc": "Traits, threads, async"
  }
];
const lessons = [
  {
